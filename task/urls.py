...
from .views import new_task, task_created_success, welcome_page, task_list, my_tasks, delete_task
...
urlpatterns = [
    ...
    path('delete_task/<str:task_name>/', delete_task, name='delete_task'),
